...
echo                                                              %mydate% - %mytime%
echo.
echo  KMS (Inject) Activation Windows ^& Office %ver% - mephistooo2 - www.TNCTR.com 
echo.
...
title KMS (Inject) Aktivasyon Windows ^& Office %ver% by mephistooo2 - TNCTR.com
...
copy /y "%xOS%\KMS.dll" "%SystemRoot%\system32" %_Nul_1_2%
...
del /f /q "%SystemRoot%\system32\KMS.dll" %_Nul_1_2%
...
if %winbuild% GEQ 9200 reg add "%IFEO%\%1" /f /v Office2013 /t REG_SZ /d %Office2013% %_Nul_1_2%
)
if /i %1 EQU osppsvc.exe (
reg add "%IFEO%\%1" /f /v Office2010 /t REG_SZ /d %Office2010% %_Nul_1_2%
if %winbuild% LEQ 7601 reg add "%IFEO%\%1" /f /v Office2013 /t REG_SZ /d %Office2013% %_Nul_1_2%
)
goto :EOF
::===============================================================================================================
:RemoveIFEOEntry
...
for %%A in (Debugger,KMS_Emulation,KMS_ActivationInterval,KMS_RenewalInterval,Office2010,Office2013) do reg delete "%IFEO%\%1" /v %%A /f %_Nul_1_2%
...
::===============================================================================================================
:sppchk
wmic path %spp% where ID='%app%' get Name | findstr /i "Office" %_Nul_1% && (set office=1) || (set office=0)
...
echo Please wait...
echo.
copy /b /v /y "%xOS%\KMS.dll" "%SystemRoot%\system32" >nul 2>&1 && (echo KMS.dll file copied) || (echo KMS.dll file was not copied)
echo.
schtasks /create /tn "KMS_Activation" /xml "%~dp0x86\KMS.xml" /f >nul 2>&1
Call "%~dp0x86\Task.cmd" 
