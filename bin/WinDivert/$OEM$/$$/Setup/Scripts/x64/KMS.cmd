...
for %%p in ("KMS.exe") do set "ServerPath=%%~fp"
...
cmd /c start /b /high "" "KMSClient.exe" %KMS_IP% %_Nul_1_2%
)
...
wmic path %spp% where (Description like '%%KMSCLIENT%%') get Name %_Nul_2% | findstr /i Office %_Nul_1% && (set office15=1) || (if not defined win7 echo. )
...
find /i "Office" sppchk.txt %_Nul_1% && (set office=1) || (set office=0)
...
::===============================================================================================================
:osppchk
wmic path %spp% where ID='%app%' get Name | findstr /i /C:"Office 14" %_Nul_1% && (set off14=1&if %loc_off14% equ 0 exit /b) || (set off14=0)
wmic path %spp% where ID='%app%' get Name | findstr /i /C:"Office 15" %_Nul_1% && (if %loc_off15% equ 0 exit /b)
wmic path %spp% where ID='%app%' get Name | findstr /i /C:"Office 16" %_Nul_1% && (if %loc_off16% equ 0 exit /b)
